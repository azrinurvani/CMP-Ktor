...
import com.azrinurvani.cmp_ktor.util.onError
import com.azrinurvani.cmp_ktor.util.onSuccess
...
fun App(client : InsultCensorClient) {
    MaterialTheme {
        ...
        var uncensoredText by remember { //temp uncensored text from text field
            mutableStateOf("")
        }
